...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      title: "Top Companies",
      description: "Connect with leading companies from innovative startups to fortune 500 corporative",
      benefits: [
    ...
    },
    {
      ...
      title: "Talent Pool",
      description: "Employers can access a diverse pool of qualified candidates for their open position",
      benefits: [
    ...
    <main>
      ...
      <section className="py-20 bg-gradient-to-b from-[#d7dedc] to-[#7263f3]/5 text-primary-foreground">
        <div className="container mx-auto px-4 text-center text-black">
          <h1 className="text-4xl text-[#7263f3] md:text-5xl font-bold md-6">
      ...
      <section className="py-20 bg-[#f0f5fa]">
        <div className="container mx-auto px-20">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose {" "}
            <span className="font-extrabold text-[#7263f3]">Medjobber</span>
          </h2>
          ...
          className="text-sm font-medium border-gray-400">
            Trust by 10,000+ companies worldwide
          </Badge>
          </div>
        </div>
      </section>
